...
import { useRemoveAllPiRLiquidityModal } from "@/lib/stores/liquidity.store";

type Props = {};

const RemoveAllInModal = (props: Props) => {
  const { isOpen, onClose } = useRemoveAllPiRLiquidityModal();

  const data_modal = {
    title: "Remove in Range",
    symbol: "SOL - USDC",
...
export default RemoveAllInModal;
