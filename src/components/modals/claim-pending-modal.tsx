...
import { useClaimPendingModal } from "@/lib/stores/farm.store";

type Props = {};

const ClaimPendingModal = (props: Props) => {
  const { isOpen, onClose } = useClaimPendingModal();
...
export default ClaimPendingModal;
