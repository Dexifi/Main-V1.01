...
import { useClaimAllLiquidityModal } from "@/lib/stores/liquidity.store";

type Props = {};

const ClaimAllPendingModal = (props: Props) => {
  const { isOpen, onClose } = useClaimAllLiquidityModal();
...
export default ClaimAllPendingModal;
