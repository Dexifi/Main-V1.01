...
import { useRemoveAllPoRLiquidityModal } from "@/lib/stores/liquidity.store";

type Props = {};

const RemoveAllOutModal = (props: Props) => {
  const { isOpen, onClose } = useRemoveAllPoRLiquidityModal();

  const data_modal = {
    title: "Remove out of Range",
    symbol: "SOL - USDC",
...
export default RemoveAllOutModal;
