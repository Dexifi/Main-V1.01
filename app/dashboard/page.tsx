...
import { ManageModal } from "@/components/modals";
  ...
  return (
    <DashboardProvider>
      ...
      <div className="bg-[#0d111b] relative min-h-screen w-full flex items-center flex-col">
        ...
        <div className="container relative  min-h-screen w-full pt-4 overflow-x-hidden mb-12">
          <div
            className="absolute -top-96 left-[calc(50% - 866px)] min-h-screen  w-[54rem] h-[32rem] lg:h-[64rem] overflow-hidden"
            style={{
              background:
          ...
          />
          <ManageModal />
          {isClient && <DashboardHeader isMobile={isEXTRASMALL} />}
        </div>
      </div>
    </DashboardProvider>
  );
